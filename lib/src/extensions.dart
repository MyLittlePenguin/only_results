...
extension FutureExtensions<O, E> on Future<Result<O, E>> {
  ...
  Future<Result<O2, E>> andThenAsync<O2>(Future<Result<O2, E>> Function(O ok) fn,) async {
  ...
  Future<Result<O, E2>> orElseAsync<E2>(Future<Result<O, E2>> Function(E err) fn) async {
